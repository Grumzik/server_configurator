uuid: a398ed07-913b-474f-a9e4-6785a3669559
langcode: ru
status: true
dependencies: {  }
id: upgrade_d7_pathauto_patterns_node_moduleserver_components
...
label: 'Pathauto patterns (node - moduleserver_components)'
source:
  ...
  entity_type: node
  bundle: moduleserver_components
process:
  status:
    -
      plugin: get
